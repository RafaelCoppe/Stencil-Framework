...
replace github.com/RafaelCoppe/Stencil-Framework/core/http => ./core/http
...
require (
	...
	github.com/RafaelCoppe/Stencil-Framework/core/http v0.0.0-00010101000000-000000000000
